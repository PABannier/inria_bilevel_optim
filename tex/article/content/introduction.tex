...
Multi-task Lasso:
\jo{before jumping into the code,  may be write here the optimization problem for the Multi-task lasso, and the weighted version.}


Multi-task weighted Lasso:\jo{you might need to find a reference where this has first appearead, I am not sure. @qbe @alex: any idea of the original paper for that?}
