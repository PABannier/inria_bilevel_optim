...
$\lvert\lvert x_{j} \rvert\rvert$ is the Euclidean norm of the vector $x_{j}$. We can convince ourselves that if $\forall j \in \{1, \dots, J\}, p_j = 1$, then $\lvert\lvert x_{j} \rvert\rvert_2 = \lvert x_{j} \rvert$,
